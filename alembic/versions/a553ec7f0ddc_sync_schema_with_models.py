...
down_revision: Union[str, Sequence[str], None] = 'a86fb37edbd1'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('notifications', schema=None) as batch_op:
        batch_op.add_column(sa.Column('time', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
        ...
        batch_op.add_column(sa.Column('recurring', sa.Boolean(), server_default=sa.text('FALSE'), nullable=False))
        batch_op.add_column(sa.Column('recurrence_pattern', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
