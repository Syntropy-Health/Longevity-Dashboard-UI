...
def upgrade() -> None:
    ...
    op.create_table('biomarker_aggregates',
    ...
    with op.batch_alter_table('biomarker_aggregates', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_biomarker_aggregates_period'), ['period'], unique=False)
    ...
    with op.batch_alter_table('biomarker_definitions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_biomarker_definitions_category'), ['category'], unique=False)
        batch_op.create_index(batch_op.f('ix_biomarker_definitions_code'), ['code'], unique=True)
        batch_op.create_index(batch_op.f('ix_biomarker_definitions_name'), ['name'], unique=False)

    op.create_table('clinic_daily_metrics',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('clinic_daily_metrics', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_clinic_daily_metrics_date'), ['date'], unique=False)
    ...
    with op.batch_alter_table('patient_visits', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_patient_visits_period'), ['period'], unique=False)

    op.create_table('treatment_protocol_metrics',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('category', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    with op.batch_alter_table('treatment_protocol_metrics', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_treatment_protocol_metrics_name'), ['name'], unique=False)
    ...
    with op.batch_alter_table('treatments', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_treatments_treatment_id'), ['treatment_id'], unique=True)
    ...
    with op.batch_alter_table('biomarker_readings', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_biomarker_readings_biomarker_id'), ['biomarker_id'], unique=False)
    ...
    with op.batch_alter_table('call_logs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_call_logs_call_id'), ['call_id'], unique=True)
    ...
    with op.batch_alter_table('patient_treatments', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_patient_treatments_treatment_id'), ['treatment_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_patient_treatments_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('provider_metrics', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_provider_metrics_period'), ['period'], unique=False)
        batch_op.create_index(batch_op.f('ix_provider_metrics_provider_id'), ['provider_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_provider_metrics_provider_name'), ['provider_name'], unique=False)
    ...
    with op.batch_alter_table('call_transcripts', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_call_transcripts_call_id'), ['call_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_call_transcripts_call_log_id'), ['call_log_id'], unique=False)
    ...
    with op.batch_alter_table('checkins', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_checkins_checkin_id'), ['checkin_id'], unique=True)
    ...
    with op.batch_alter_table('food_log_entries', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_food_log_entries_checkin_id'), ['checkin_id'], unique=False)
    ...
    with op.batch_alter_table('medication_entries', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_medication_entries_checkin_id'), ['checkin_id'], unique=False)
    ...
    with op.batch_alter_table('symptom_entries', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_symptom_entries_checkin_id'), ['checkin_id'], unique=False)
