                    ...
                    rx.flex(
                        rx.flex(
                            rx.match(
                                ...
                                ("info", rx.icon("info", class_name="w-6 h-6 text-blue-400")),
                                ("warning", rx.icon("triangle-alert", class_name="w-6 h-6 text-amber-400")),
                                ("success", rx.icon("circle-check", class_name="w-6 h-6 text-emerald-400")),
                                ("error", rx.icon("circle-x", class_name="w-6 h-6 text-rose-400")),
                                ("appointment", rx.icon("calendar", class_name="w-6 h-6 text-teal-400")),
                                ("treatment", rx.icon("activity", class_name="w-6 h-6 text-purple-400")),
                                ("lab", rx.icon("flask-conical", class_name="w-6 h-6 text-cyan-400")),
                        ...
                        rx.radix.primitives.dialog.close(
                            rx.button(
                                rx.icon("x", class_name="w-5 h-5 text-slate-400 hover:text-white"),
