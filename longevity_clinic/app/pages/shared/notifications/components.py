...
def notification_type_badge(notification_type: str) -> rx.Component:
    ...
    return rx.match(
        ...
        (
            ...
            rx.box(
                "Info",
                class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700",
            ),
        ),
        (
            "warning",
        ...
        (
            ...
            rx.box(
                "Success",
                class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-700",
            ),
        ),
        (
            "error",
            rx.box(
                "Error",
                class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-rose-100 text-rose-700",
            ),
        ),
        (
            "appointment",
            rx.box(
                "Appointment",
                class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-teal-100 text-teal-700",
            ),
        ),
        (
            "treatment",
        ...
        (
            ...
            rx.box(
                "Lab",
                class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-cyan-100 text-cyan-700",
            ),
        ),
        rx.box(
            notification_type,
            class_name="px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600",
        ),
    )
        ...
        rx.flex(
            ...
            rx.box(
                rx.match(
                    ...
                    (
                        "warning",
                        rx.icon("triangle-alert", class_name="w-5 h-5 text-amber-500"),
                    ),
                    (
                        "success",
                        rx.icon("circle-check", class_name="w-5 h-5 text-emerald-500"),
                    ),
                    ...
                    (
                        "lab",
                        rx.icon("flask-conical", class_name="w-5 h-5 text-cyan-500"),
                    ),
            ...
            rx.box(
                rx.flex(
                    ...
                    rx.cond(
                        ~notification.get("is_read", False),
                        rx.box(class_name="w-2 h-2 rounded-full bg-teal-500"),
                        rx.fragment(),
                    ),
            ...
            rx.flex(
                rx.button(
                    ...
                    on_click=lambda: NotificationState.mark_as_read(
                        notification.get("id", "")
                    ),
...
def filter_tabs() -> rx.Component:
    ...
    return rx.flex(
        rx.button(
            ...
            """,
            data_state=rx.cond(
                NotificationState.filter_type == "all", "active", "inactive"
            ),
        ),
        rx.button(
            rx.flex(
            ...
            """,
            data_state=rx.cond(
                NotificationState.filter_type == "unread", "active", "inactive"
            ),
        ),
        rx.button(
            "Read",
            ...
            """,
            data_state=rx.cond(
                NotificationState.filter_type == "read", "active", "inactive"
            ),
        ),
