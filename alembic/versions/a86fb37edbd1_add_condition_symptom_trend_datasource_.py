...
down_revision: Union[str, Sequence[str], None] = '6ac5be89f361'
...
def upgrade() -> None:
    ...
    op.create_table('symptom_trends',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    with op.batch_alter_table('symptom_trends', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_symptom_trends_symptom_name'), ['symptom_name'], unique=False)
        batch_op.create_index(batch_op.f('ix_symptom_trends_user_id'), ['user_id'], unique=False)
