        ...
        rx.el.nav(
            rx.cond(
                ...
                rx.el.div(
                    ...
                    sidebar_item(
                        "Patient Health", "heart-pulse", "/admin/patient-health"
                    ),
                    sidebar_item(
                        "Treatment Library", "stethoscope", "/admin/treatments"
                    ),
                    sidebar_item("Check-ins", "mic", "/admin/checkins"),
                    sidebar_item("AI Medical Expert", "brain", "/admin/chat"),
                ...
                rx.el.div(
                    ...
                    sidebar_item(
                        "Biomarker Analytics", "bar-chart", "/patient/analytics"
                    ),
                    sidebar_item(
                    ...
                    sidebar_item("AI Clinician", "brain", "/patient/chat"),
