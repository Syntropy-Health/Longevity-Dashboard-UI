...
# Test state imports
uv run python -c "from longevity_clinic.app.states.patient_dashboard_state import PatientDashboardState; print('OK')"
```
...
**Key Files**:
- `states/patient_dashboard_state.py` - modal handlers
