...
| `_gt` | Greater than | `filter[call_duration][_gt]=60` |
| `_gte` | Greater than or equal | `filter[call_date][_gte]=2025-01-01` |
| `_lt` | Less than | `filter[call_duration][_lt]=300` |
...
| `call_duration` | integer | No | Duration of the call in seconds |
...
params = {
    ...
    "filter[call_duration][_gt]": 60,  # Calls longer than 1 minute
}
```
