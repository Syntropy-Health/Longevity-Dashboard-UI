...
Health data states have been decomposed into separate modules in states/shared/dashboard/.
Admin patient viewing is handled by AdminPatientHealthState in states/admin/.
"""
